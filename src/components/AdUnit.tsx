...
const bookAds = [
  {
    ...
    url: 'https://www.amazon.com/s?k=Designed+to+Feel+Peter+Burchardt&tag=50bestbooks-20',
    accent: '#d4af37',
    accentEnd: '#c4a87c',
  },
  {
    ...
    url: 'https://www.amazon.com/s?k=The+Tribe+Manager+Peter+Burchardt&tag=50bestbooks-20',
    accent: '#22c55e',
    accentEnd: '#16a34a',
  },
  {
    ...
    url: 'https://www.amazon.com/s?k=The+Happiness+Blueprint+Peter+Burchardt&tag=50bestbooks-20',
    accent: '#d4af37',
    accentEnd: '#c4a87c',
  },
  {
    ...
    url: 'https://www.amazon.com/s?k=Happy+Employees+Peter+Burchardt&tag=50bestbooks-20',
    accent: '#eab308',
    accentEnd: '#ca8a04',
  },
  {
    ...
    url: 'https://www.amazon.com/s?k=Happy+Children+Peter+Burchardt&tag=50bestbooks-20',
    accent: '#e6c619',
    accentEnd: '#d4af37',
  },
];
